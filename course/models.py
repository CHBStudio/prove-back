...
class Course(Model):
    ...
    cost_discount = models.IntegerField(null=True, blank=True, verbose_name='Стоимость со скидкой')
    cost = models.IntegerField(null=False, blank=False, verbose_name='Стоимость без скидки')
